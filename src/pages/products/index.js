...
const Productshomepage = ({ products }) => {
  ...
  useEffect(() => {
    ...
    // Sort: in-stock products first, then out-of-stock ones
    results.sort((a, b) => (b.instock - a.instock));
  ...
  return (
    <>
      ...
      <section className="bg-slate-50 px-4">
        <div className="container flex flex-col justify-center items-center mx-auto h-full w-full md:max-w-2xl lg:max-w-3xl xl:max-w-6xl">
          <div className="py-32 lg:py-16 w-full mt-4 flex flex-col gap-16">
              ...
              <div className="flex flex-col lg:flex-row gap-4 justify-between">
                ...
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
                  ...
                  <ButtonGroup variant="segmented">
                    ...
                    <Button
                      pressed={filter === 'brand new'}
                      onClick={() => handleFilterChange('brand new')}
                    >
                      Brand New
                    </Button>
                    <Button
                    ...
                    <Button
                      pressed={filter === 'like new'}
                      onClick={() => handleFilterChange('like new')}
                    >
                      Like New
                    </Button>
                  </ButtonGroup>
