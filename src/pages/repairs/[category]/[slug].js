...
export default function RepairPage({ repair, category }) {
  ...
  const seo = {
    title: repair?.hero?.heroTitle || 'Default Title',
    description:  'Default Description',
    openGraph: {
      url: 'https://www.itechcare.com.au',
      title: repair?.hero?.heroTitle || 'Default Title',
      description: repair?.hero?.heroDescription || 'Default Description',
      images: [
        {
          url: repair.coverImage ? urlForImage(repair.coverImage).url() : '/cover-image.png',
          width: 1200,
          height: 630,
          alt: 'Cover Image',
        },
      ],
      site_name: 'iTech Care',
    },
    twitter: {
      handle: '@itechcare',
      site: '@itechcare',
