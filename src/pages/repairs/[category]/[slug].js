...
/>
      ...
      <main className="bg-zinc-100">
        <section className=" bg-zinc-100 h-fit lg:h-[540px]">
        ...
        <div className="relative container mx-auto md:max-w-2xl items-center px-4 lg:px-0 lg:max-w-3xl xl:max-w-6xl flex flex-col gap-16" style={{ zIndex: 2 }}>
        <div className="flex flex-col gap-4 items-center text-center w-full lg:w-2/3">
          <h2 className="text-3xl font-normal text-zinc-900">
          Choose iTech Care for 
          <span className="block">{`top-tier ${repair.repairItemTitle} repair benefits.`}</span>
          </h2>
          <p className='text-lg text-zinc-500 font-normal normal-case w-full'>{`Choose iTech Care for reliable, high-quality ${repair.repairItemTitle} repairs
            backed by excellent service and customer-focused solutions.`}</p>

        </div>
        <div className="flex flex-col lg:flex-row gap-4 w-full ">
            <div className="w-full  xl:w-1/3 flex flex-col h-[680px] md:h-[1080px] md:h-[650px]  bg-zinc-900">
            ...
            <p className="text-base text-zinc-300">{`Our expert technicians provide precise ${repair.repairItemTitle} repairs to restore your device’s performance and functionality.`}</p>
            </div>
            </div>
            <div className="w-full  xl:w-1/3 flex flex-col h-[580px] md:h-[650px]  bg-zinc-900">
            ...
            <p className="text-base text-zinc-300">{`We use premium-grade components for every ${repair.repairItemTitle} repair, ensuring durability and optimal results.`}</p>
            </div>
            </div>
            <div className="w-full  xl:w-1/3 flex flex-col h-[580px] md:h-[650px]  bg-zinc-900">
            ...
            <p className="text-base text-zinc-300">{`All ${repair.repairItemTitle} services come with our commitment to excellence, backed by a satisfaction guarantee.`}</p>
            </div>
            </div>
          </div>
...
<h2 className="text-center font-normal text-3xl "> Booking a repair in
...
>
  ...
  />
    ...
    <div className="flex flex-col items-center gap-4 px-2  bg-zinc-100 ">
